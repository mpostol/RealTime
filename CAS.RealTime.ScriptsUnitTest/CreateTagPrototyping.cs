...
namespace CAS.CodeProtect.Scripts.UnitTest
{
  ...
  public class CreateTagPrototyping
  {
    ...
    public void CreateTagTest()
    {
      ...
      string _solutionPath = @"/CAS.RealTime";
      string _trunkPath = $@"{_repositoryUrl}trunk{_solutionPath}/";
      string _tagPath = $@"{_repositoryUrl}tags{_solutionPath}.rel_{_rel}";
      #endregion

      Assert.AreEqual("svn://svnserver.hq.cas.com.pl/VS/trunk/CAS.RealTime/", _trunkPath);
      Assert.AreEqual("svn://svnserver.hq.cas.com.pl/VS/tags/CAS.RealTime.rel_2_01_1061", _tagPath);
